...
const  talk=()=>{
  ...
  let response = await fetch(`https://sandbox.prestigedelta.com/analystreport/?thread_id=${thread[thread.length - 1].gpt_thread_id}&category=${valv.selectedValue.value}&report=sales`,{
  method: "GET",
